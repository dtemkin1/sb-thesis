...
\documentclass[twoside, fontset=termes-stix2]{mitthesis}% fontset=libertinus, fontset=lmodern, fontset=lucida, 
...
\addbibresource{sources.bib}%% <== change to YOUR bib file <= CHANGE
...
% 
	pdfkeywords={Massachusetts Institute of Technology, MIT, bus networks, transportation operations, urban planning, category theory, Diego Temkin},
...
\title{Reimagining Urban Bus Operations: Using Applied Category Theory to Create a Generalized Framework for Bus Network Redesigns that Incorporates Equitable Factors}
...
\Supervisor{Jim Aloisi}{Lecturer of Transportation Policy and Planning}
\Acceptor{Justin Steil}{Associate Professor of Law and Urban Planning}{UG Committee Chair, Department of Urban Studies and Planning} % \\ \> Third title}
