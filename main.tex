...
\documentclass[fontset=termes-stix2,twoside]{mitthesis}
...
\hypersetup{%
	pdfsubject={A thesis applying monotone co-design theory and bus routing optimization to evaluate school bus network redesign tradeoffs in Framingham, Massachusetts.},
	% Change this to briefly state topic of your thesis 
% 
	pdfkeywords={Massachusetts Institute of Technology, MIT, \CopyrightAuthor, school bus routing, bus network redesign, monotone co-design, applied category theory, mixed-integer linear programming, Biobjective Routing Decomposition, Bus Routing Algorithm, transportation equity, transit planning, Pareto fronts, Framingham Public Schools, accessibility, student transportation},
...
\includeonly{
    acknowledgments,
    chapters/1-intro,
    chapters/2-litreview,
    chapters/3-methods,
    chapters/4-results,
    chapters/5-discussion,
    chapters/6-conclusions,
    appendices/a-stakeholder,
    appendices/b-math,
    appendices/c-mcdpl,
    appendices/d-acronyms
}
...
\title{A Co-Design Framework for School Bus Network Redesign: Applying Category Theory to Routing, Resources, and Equity}
...
\include{chapters/1-intro}% .tex extension is presumed
\include{chapters/2-litreview}
...
\appendix
\include{appendices/a-stakeholder}
\include{appendices/b-math}
\include{appendices/c-mcdpl}
\include{appendices/d-acronyms}
