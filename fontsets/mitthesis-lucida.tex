...
\else
    ...
    % ss01 		Lucida Sans & Typewriter 	use dotted zero: ðŸ¶ vs. default 0.
    % ss01 		use Lucida-standard shapes:
    % 			Lucida Grande Mono 			Ã˜OQ vs. default 0OQ;
    % 			Lucida Console 				Ã˜OQ vs. default 0OQ.
    ...
    %% MATH FONTS
    %
    % ss01 	alternate Latin lower case math italic identical to text italic. This option is not recommended as Greek ðœˆ (nu) and Latin ð‘£ (vee) become too similar
    % ss02 	smaller arrows (original Type 1 size): â‡‘ vs. default â‡‘.
    ...
    % ss05 	use a slashed-zero style for the empty set character (U+2205): Ã˜ vs. default âˆ…
    % ss08 	emphasize right and bottom edges of the dâ€™Alembertian operator (U+29E0, \laplac), to follow the design of the Laplace operator (U+2206, \increment, Î”); the default design emphasizes the left and upper edges. Also available in the bold math font.
    %
