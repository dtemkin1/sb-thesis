...
\begin{figure}[!htbp]
    ...
    \caption{Simplified co-design diagram, illustrating how different components and their respective functionalities/requirements interact.}
    \label{fig:codesign}
\end{figure}
...
\[
a_{m,b,a} \leq r_b^{\mathrm{mon}} \qquad \forall m\in\mathcal{F},\forall b\in\mathcal{B},\forall q\in\mathcal{Q}
\]
\[
a_{m,b,a} \leq W_b \qquad \forall m\in\mathcal{W},\forall b\in\mathcal{B},\forall q\in\mathcal{Q}
\]
